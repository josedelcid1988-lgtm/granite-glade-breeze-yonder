import type { Stage, SupportProcess } from "./types";

const months = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep"];

function series(values: Array<number | null>) {
  return months.map((month, i) => ({ month, value: values[i] ?? null }));
}
...
export const stages: Stage[] = [
  {
    ...
    color: "primary",
    intent:
      "Convert an opportunity into an approved program with defined customer, statutory and regulatory requirements, and confirm Skyryse can meet them before it commits.",
    inputs: [
    ...
    as9100: ["8.2", "8.2.2", "8.2.3"],
    cfr: ["None applied directly at this stage"],
    records:
      "Outputs are quality records, controlled and retained under P-750. Personnel are competent and authorized under P-720.",
    ...
    metrics: [
      {
        ...
        current: 100,
        status: "on-target",
        series: series([100, 100, 100, 100, 100, 100, 100, 100, 100]),
      },
    ],
    processes: [
      {
  ...
  },
  {
    ...
    color: "primary",
    intent:
      "Design, verify and validate SkyOS hardware and software against the requirement set, and release the design under configuration control.",
    inputs: [
    ...
    procedureIds: ["p-830", "p-812", "p-750"],
    tools: ["Polarion", "Git", "SolidWorks PDM"],
    as9100: ["8.1.2", "8.3"],
  ...
  },
  {
    ...
    color: "primary",
    intent:
      "Translate the released design into a producible configuration and define where conformity will be verified.",
    inputs: [
    ...
    procedureIds: ["p-812", "p-850", "p-830"],
    tools: ["SolidWorks PDM", "NetSuite"],
    as9100: ["8.1.2", "8.1.3", "8.5.1"],
  ...
  },
  {
    ...
    color: "primary",
    intent:
      "Approve sources, place purchase orders with quality requirements flowed down, and accept the material Manufacturing builds with. Skyryse remains responsible for all externally provided processes, products and services.",
    inputs: [
      "Released bill of material and make or buy determination",
    ...
    procedureIds: ["p-840", "p-814", "p-852"],
    tools: ["NetSuite", "Jira"],
    as9100: ["8.1.4", "8.4"],
    ...
    metrics: [
      {
        ...
        current: 92,
        status: "on-target",
        series: series([94, 93, 91, 90, 92, 93, 91, 92, 92]),
      },
      {
        id: "s4-otd",
        ...
        series: series([68, 70, 71, 72, 73, 74, 73, 75, 74]),
      },
    ],
    processes: [
      {
  ...
  },
  {
    ...
    color: "primary",
    intent:
      "Build the article to the released configuration on a released work order and verify its conformity in process and at acceptance test. Inspection and test status is identifiable at all times.",
    inputs: [
      "Accepted material",
    ...
    procedureIds: ["p-850", "p-852", "p-851", "p-714"],
    tools: ["NetSuite", "Jira", "SolidWorks PDM"],
    as9100: ["8.5.1", "8.5.1.3", "8.5.2", "8.5.4"],
    cfr: [
    ...
    metrics: [
      {
        ...
        series: series([91, 90, 89, 88, 87, 88, 86, 88, 88]),
      },
    ],
    processes: [
      {
      ...
      },
      {
        id: "s5-assembly",
        name: "Assembly",
        procedureIds: ["p-850", "p-714", "p-851"],
        sopIds: ["sop-850-002"],
        formIds: ["f-850-001"],
        tools: ["NetSuite", "Jira"],
        jiraType: "Work Order",
      ...
      },
      {
        ...
        procedureIds: ["p-850", "p-851", "p-852"],
        sopIds: ["sop-850-006"],
        formIds: [],
        tools: ["NetSuite"],
        jiraType: "Internal Discrepancy",
  ...
  },
  {
    ...
    color: "primary",
    intent:
      "Install SkyOS on the aircraft and verify its performance in the installed configuration. Findings return to Product Development.",
    inputs: [
    ...
    procedureIds: ["p-830", "p-850", "p-852"],
    tools: ["Jira", "Polarion"],
    as9100: ["8.5.1", "8.6"],
    ...
    metrics: [
      {
        ...
        series: series([null, null, null, null, null, null, null, null, null]),
      },
    ],
    processes: [
      {
  ...
  },
  {
    ...
    color: "primary",
    intent:
      "Establish conformity of parts, test set-ups and finished articles, and verify the configuration against the released design before rate production.",
    inputs: [
    ...
    process: ["Part conformity", "Test set-up conformity", "Final inspection and conformity determination"],
  ...
  },
  {
    ...
    color: "primary",
    intent:
      "Produce the released configuration at rate, issue authorized release documents, and deliver the product with its conformity preserved.",
    inputs: [
    ...
    procedureIds: ["p-850", "p-860", "p-852", "p-851", "p-853"],
    tools: ["NetSuite", "Jira", "SolidWorks PDM"],
    as9100: ["8.5.1", "8.5.3", "8.5.4", "8.5.6", "8.6"],
    cfr: [
      "21.137(d) manufacturing process control",
      "21.137(j) handling and storage",
    ...
    processes: [
      ...
      },
      {
        id: "s8-pack",
        name: "Packaging",
        procedureIds: ["p-850", "p-851", "p-853"],
        sopIds: ["sop-850-006"],
        formIds: ["f-850-007"],
        tools: ["NetSuite"],
        jiraType: "Work Order",
  ...
  },
  {
    ...
    color: "primary",
    intent:
      "Support the product in service and return what is learned to Product Development. Quality escapes are notified to customers and, where applicable, the FAA.",
    inputs: [
      "Delivered product",
    ...
    procedureIds: ["p-820", "p-830", "p-870", "p-1000"],
    tools: ["Jira", "NetSuite"],
    as9100: ["8.5.5", "10.2"],
    ...
    processes: [
      ...
      },
      {
        ...
        summary:
          "A quality escape is nonconforming product released from the quality system. Notify affected customers within 48–72 hours of discovery.",
        howTo: [
...
export const supportProcesses: SupportProcess[] = [
  {
    id: "sup-docs",
  ...
  },
  {
    ...
    tools: ["Jira"],
    as9100: ["8.7", "10.2"],
    cfr: ["21.137(h)", "21.137(i)", "21.137(n)"],
...
export function getProcess(id: string) {
  for (const stage of stages) {
    ...
    if (process) return { process, stage };
  }
  return null;
}
