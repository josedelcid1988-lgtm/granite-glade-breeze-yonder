...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-mxZz9WWb.mjs");
...
var manifest = { "51ad1319a40a6c5a224a9ee5f1f8e8421ceb5f1650bd0bbe8c063ff004624321": {
	functionName: "askQualityAssistant_createServerFn_handler",
	importer: () => import("./chat-Cij5X8Hl.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-vGhTjsjz.mjs").then((n) => n.t),
